...
<body>
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-vertical" action="add_department.php" method="POST" id="departmentForm">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Input Department Short Name" id="first-name-icon" name="department_short_name" required>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Input Department Name" id="email-id-icon" name="department_name" required>
                                                                <div class="form-control-icon">
                                                                    <i class="fa fa-table"></i>
                                                                </div>
                                                            </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT COUNT(*) as count FROM departments WHERE department_name = ?";
        ...
        $insert_query = "INSERT INTO departments (department_short_name, department_name) VALUES (?, ?)";
        $insert_stmt = $conn->prepare($insert_query);
        $insert_stmt->bind_param("ss", $department_short_name, $department_name);
