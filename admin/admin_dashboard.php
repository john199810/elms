              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      <div class="align-self-center">
                        <i class="fa fa-building text-warning fa-3x me-4"></i>
                      </div>
                      <div>
                        <h4>Departments</h4>
                        <h2 class="h1 mb-0"><?php echo $total_departments; ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      <div class="align-self-center">
                        <i class="fa fa-briefcase text-warning fa-3x me-4"></i>
                      </div>
                      <div>
                        <h4>Designations</h4>
                        <h2 class="h1 mb-0"><?php echo $total_designations; ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      ...
                      <div>
                        <h4>Approved</h4>
                        <h2 class="h1 mb-0"><?php echo $total_approved; ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      ...
                      <div>
                        <h4>Pending</h4>
                        <h2 class="h1 mb-0"><?php echo $total_pending; ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between p-md-1">
                    <div class="d-flex flex-row">
                      ...
                      <div>
                        <h4>Canceled</h4>
                        <h2 class="h1 mb-0"><?php echo $total_cancelled; ?></h2>
                      </div>
                    </div>
                  </div>
                </div>
