...
<body>
                        ...
                        <div class="col-md-8 col-12">
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" method="POST" action="add_leave_type.php">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="leave-name-icon">Leave Name</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Input leave type" id="leave-name-icon" name="leave_name">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Input Description" id="description-icon" name="leave_description">
                                                                <div class="form-control-icon">
                                                                    <i class="fa fa-table"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="days-allowed-icon">Number of days
                                                                Allowed</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" placeholder="Input days allowed" id="days-allowed-icon" name="days_allowed">
                                                                <div class="form-control-icon">
                                                                    <i class="fa fa-table"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12 d-flex justify-content-end">
                                                        <button type="submit" class="btn btn-primary me-1 mb-1" name="add_leave_type">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Check if leave_name already exists
        $query = "SELECT COUNT(*) as count FROM leavetypes WHERE leave_name = ?";
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error!',
            text: 'Leave name already exists.',
        }).then((result) => {
            if (result.isConfirmed || result.isDismissed) {
                window.location.href = 'add_leave_type.php';
            }
        });
    </script>";
            exit;
        ...
        // Insert leavetypes into database
        $insert_query = "INSERT INTO leavetypes (leave_name, leave_description,number_of_days_allowed) VALUES (?, ?,?)";
        $insert_stmt = $conn->prepare($insert_query);
        $insert_stmt->bind_param("sss", $leave_name, $leave_description, $days_allowed);
        ...
        Swal.fire({
            icon: 'success',
            title: 'Success!',
            text: 'Leavetype added successfully.',
        }).then((result) => {
            if (result.isConfirmed || result.isDismissed) {
                window.location.href = 'add_leave_type.php';
            }
            ...
            // Error inserting Leavetype
            echo "<script>
        Swal.fire({
            icon: 'error',
            title: 'Error!',
            text: 'Failed to add Leavetype.',
        }).then((result) => {
            if (result.isConfirmed || result.isDismissed) {
                window.location.href = 'add_leave_type.php';
            }
