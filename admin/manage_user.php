...
<body>
   <div id="app">
      ...
      <div id="main">
         ...
         <div class="main-content container-fluid">
            ...
            $sql = "SELECT user_id, username, full_name, contact_number, user_category, account_status, profile_image FROM users";
                     ...
                     <table class='table' id="table1">
                        ...
                        <tbody>
                           ...
                           while ($row = $result->fetch_assoc()) {
                              ...
                              $profile_image = !empty($row['profile_image']) ? '../assets/admin/img/' . $row['profile_image'] : '../assets/img/default.png';
                           ?>
                              <tr>
                                 <td><img src="<?php echo $profile_image; ?>" alt="Profile Image" class="profile-img"></td>
                                 <td><?php echo $row['full_name']; ?></td>
                                 <td><?php echo $row['contact_number']; ?></td>
                                 <td><?php echo $row['user_category']; ?></td>

                                 <td><span class="badge <?php echo $status_class; ?>"><?php echo $row['account_status']; ?></span></td>
                                 <td>
                                    <!-- Edit Modal Trigger -->
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $row['user_id']; ?>"><i class="fa fa-pen text-success"></i></a>
                                    <!-- Delete Modal Trigger -->
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $row['user_id']; ?>"><i class="fa fa-trash text-danger"></i></a>
                                       ...
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel<?php echo $row['user_id']; ?>">Edit Status</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                             </div>
                                             <div class="modal-body">
                                                <!-- Form to edit user status -->
                                    ...
                                    <div class="modal fade" id="deleteModal<?php echo $row['user_id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?php echo $row['user_id']; ?>" aria-hidden="true">
                                       <div class="modal-dialog">
                                          <div class="modal-content">
                                             <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel<?php echo $row['user_id']; ?>">Confirm Delete</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                             </div>
                                             <div class="modal-body">
   ...
   <script>
      ...
      const statusUpdate = urlParams.get('edit_status');
