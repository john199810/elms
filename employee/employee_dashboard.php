          ...
          <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <a class="dropdown-item" href="view_employee.php?employee_id=<?php echo $employee_id; ?>">
                  <i data-feather="user"></i> View Profile
                </a>
                <a class="dropdown-item" href="update_password.php?employee_id=<?php echo $employee_id; ?>"><i data-feather="lock"></i> Account</a>
